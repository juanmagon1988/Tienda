...
<div class="table-cart">
	...
	<div class="table-responsive">
			...
			<tbody>
				@foreach($cart as $item)
					<tr>
						...
						<td>
							<input type="number" min="1" max="100" value="{{ $item->quantity }}" id="product_{{$item->id}}"> <a href="#" class="btn btn-warning btn-update-item" data-href="{{ route('cart-update', $item->slug) }}" data-id="{{ $item->id }}"><i class="fa fa-refresh"></i></a>
						</td>
						<td>$
		...
		<h3><span>Total: $ {{ number_format($total,2) }}</span></h3>
	...
	@else
		<h3><span class="label labelwarning">No hay productos en el carrito</span></h3>
	@endif
	<hr>
	<p>
